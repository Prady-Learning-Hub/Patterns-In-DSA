...
public class TestPairSumSorted {
  ...
  public void testFindPairForTargetSum_WithDuplicates_EqualsTarget() {
    ...
    boolean shouldBeTrue = Arrays.asList(expected)
        .containsAll(Arrays.asList(pairSumSorted.findPairForTargetSum(sortedNumbers, target)));
  ...
  void testFindPairForTargetSumBruteForce_NormalCase() {
    ...
    assertArrayEquals(expected,
        pairSumSorted.findPairForTargetSumBruteForce(sortedNumbers, target));
  }
  ...
  void testFindPairForTargetSumBruteForce_DuplicateElements() {
    ...
    boolean shouldBeTrue = Arrays.asList(expected).containsAll(
        Arrays.asList(pairSumSorted.findPairForTargetSumBruteForce(sortedNumbers, target)));
    assertTrue(shouldBeTrue);
  }
